...
class TestLilypond(unittest.TestCase):
    ...
    def test_empty_get_contrapunctus(self):
        """
        An empty list should return an empty string.
        """
        result = get_contrapunctus([], 1)
        self.assertEqual('', result)

    def test_good_get_contrapunctus(self):
        """
        The known good case.
        """
        raw = [5, 7, 6, 5, 8, 7, 9, 8, 7, 6, 5]
        result = get_contrapunctus(raw, 4)
        expected = "d' 4 f' e' d' g' f' a' g' f' e' d' 1"
        self.assertEqual(expected, result)

    def test_get_contrapunctus_rising_final_cadence(self):
        """
    ...
    def test_get_contrapunctus_duration_set(self):
        """
